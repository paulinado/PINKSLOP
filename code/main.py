...
from views import Learn, Progress, Settings, Learn2, Chatbot, Easy, Medium, Hard
import re
        ...
        if username in usernames:
            if authentication_status:
                ...
                with st.sidebar:
                    ...
                    options=["Easy","Medium","Hard", "Progress", "Settings", "Chat-bot"],  # required
                    icons=None,  # optional
