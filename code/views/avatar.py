...
def createPage():
    ...
    **Credits**
    ...
    list_skin_color = ['TANNED','LIGHT','PALE','LIGHT','BROWN','DARK_BROWN','BLACK']
    ...
    path_to_image = dir + "/elements/avatar.png"
    rendered_avatar = avatar.render_png_file(path_to_image)
    image = Image.open(path_to_image)
    st.image(image)
    st.markdown(imagedownload(path_to_image), unsafe_allow_html=True)
